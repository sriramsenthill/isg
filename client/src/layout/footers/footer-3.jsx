  ...
  return (
    <>
      <footer>
        ...
        >
          <div className="f-border pt-115 pb-70 text-right">
          ...
          <div className="f-copyright pt-60 pb-40" style={{alignItems:'center'}}>
            <div className="container">
              <div className="row text-center text-lg-start">
                <div className="col-xl-6 col-lg-5">
                  <div className="f-copyright__text text-center mb-30">
                    <span className="text-center">
                      ISG {new Date().getFullYear()}  All Rights Reserved
                    </span>
                  </div>
                </div>
